...
namespace Appccelerate.StateMachine.Machine
{
    ...
    where TEvent : IComparable
  {
    ...
    IState<TState, TEvent> InitialState
    {
      get;
      set;
    }
    ...
    IState<TState, TEvent> SuperState
    {
      get;
      set;
    }
    ...
    ICollection<IState<TState, TEvent>> SubStates
    {
      get;
    }
    ...
    ITransitionDictionary<TState, TEvent> Transitions
    {
      get;
    }
    ...
    IState<TState, TEvent> LastActiveState
    {
      get;
      set;
    }
    ...
    IList<IActionHolder> EntryActions
    {
      get;
    }
    ...
    IList<IActionHolder> ExitActions
    {
      get;
    }
