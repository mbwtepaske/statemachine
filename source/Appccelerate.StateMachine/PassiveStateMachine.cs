...
namespace Appccelerate.StateMachine
{
    ...
    where TEvent : IComparable
  {
    ...
    {
      stateMachine = new StateMachine<TState, TEvent>(name ?? GetType().FullNameToString(), factory);
    ...
    public void FirePriority(TEvent eventId, object eventArgument)
    {
      ...
      this.stateMachine.ForEach(
        extension => extension.EventQueuedWithPriority(this.stateMachine, eventId, eventArgument));
    ...
    /// </summary>
    /// <param name="stateMachineWriter">Data to be persisted is passed to the saver.</param>
    public void Save(IStateMachineWriter<TState> stateMachineWriter)
    {
      ...
      this.stateMachine.Save(stateMachineWriter);
    }
    ...
    /// </summary>
    /// <param name="stateMachineReader">Loader providing persisted data.</param>
    public void Load(IStateMachineReader<TState> stateMachineReader)
    {
      ...
      this.stateMachine.Load(stateMachineReader);
